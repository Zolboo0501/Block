...
export const EventIcon = () => {
  return (
    <Svg width={24} height={24} viewBox="0 0 15 15" fill="none">
      <Path
        d="M10.5 1a.5.5 0 01.5.5V2h1.5A1.5 1.5 0 0114 3.5v9a1.5 1.5 0 01-1.5 1.5h-10A1.5 1.5 0 011 12.5v-9A1.5 1.5 0 012.5 2H4v-.5a.5.5 0 011 0V2h5v-.5a.5.5 0 01.5-.5zM2 12.5l.01.1c.04.196.194.35.39.39l.1.01h10l.1-.01a.501.501 0 00.39-.39l.01-.1V6H2v6.5zM3.5 11a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm-6-2a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm-4-2a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zm2 0a.5.5 0 110 1 .5.5 0 010-1zM2.4 3.01a.5.5 0 00-.4.49V5h11V3.5a.5.5 0 00-.4-.49L12.5 3H11v.5a.5.5 0 01-1 0V3H5v.5a.5.5 0 01-1 0V3H2.5l-.1.01z"
        fill="#DEDEDE"
      />
    </Svg>
  );
